...
namespace Rixian.Drive.Storage.Abstractions
{
    ...
    public interface IDriveControllerManager
    {
        ...
        Task<IReadOnlyList<IDriveController>> ListDriveControllersAsync(Guid tenantId);
        ...
        Task<IDriveController> GetDefaultDriveControllerAsync(Guid tenantId);
        ...
        Task<IDriveController> GetDriveControllerAsync(Guid tenantId, Guid driveId);
    }
}
